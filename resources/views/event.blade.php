  ...
  <div class="row justify-content-center">
    <div class="col-md-10">
      <article>
        ...
        <p class="text-muted mt-4">Pembuat : <a href="/users/{{ $event->user->username }}" class="text-reset">{{ $event->user->name }}</a> dalam kategori <a href="/categories/{{ $event->category->slug }}" class="text-reset">{{ $event->category->name }}</a></p>
        {{-- <p>{{ $event->body }}</p> --}}
